...
par_policy.add_argument('--dilnet_input_dim', default=8)
par_policy.add_argument('--dilnet_hidden_dim', default=256)
...
par_train.add_argument('--load_name', default='r5_12/r5_12_check_point_50.pt') # '/r4_0/r4_0_check_point_250.pt' 
...
policy = ActorCritic(VOEnv.observation_space, VOEnv.action_space, args.state_dim, args.dilnet_input_dim, args.dilnet_hidden_dim, 
